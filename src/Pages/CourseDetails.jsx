...
import { buyCourse } from "../services/opreations/studentsFeatureAPI";
...
const CourseDetails = () => {
  ...
  useEffect(() => {
    const fullCourseDetails = async () => {
      try {
        ...
        console.log("Couldn't fetch the course data.... ");
      }
    };
    fullCourseDetails();
  }, [courseId]);
  ...
  return (
  //   <div className="text-white flex flex-col w-full bg-richblack-800">
        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div className="flex w-full flex-col gap-4 border-y border-y-richblack-500 py-4 lg:hidden">
              ...
              <button className="lg:yellowButton text-yellow-50" onClick={handleBuyCourse}>
                Buy Now
              </button>
              <button className="lg:blackButton text-yellow-50">Add to Cart</button>
            </div>
          </div>
          {/* Courses Card */}
