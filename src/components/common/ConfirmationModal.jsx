  ...
  return (
    <div  className="fixed inset-0 z-[1000] !mt-0 grid place-items-center overflow-auto bg-opacity-10 backdrop-blur-sm">
        <div className="w-11/12 max-w-[350px] rounded-lg border border-richblack-400 bg-richblack-800 p-6">
            ...
            <p className="mt-3 mb-5 leading-6 text-richblack-200 font-semibold">{modalData.text2}</p>

            <div  className="flex items-center gap-x-4">

              <button 
                className='w-fit p-2 bg-yellow-100 text-black rounded-md font-semibold font-mono cursor-pointer'
