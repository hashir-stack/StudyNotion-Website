  ...
  const handleEditSubSection = async () => {
    ...
    if (result) {
      const updatedCourseContent = course.courseContent.map((section) =>
        modalData.sectionId === section._id ? result : section
      );
      ...
      <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-richblack-800">
        <div className="flex items-center justify-between rounded-t-lg bg-richblack-700 p-5">
          ...
          <button onClick={() => (!loading ? setModalData(null) : {})}>
            <RiCloseFill className="text-2xl text-richblack-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 px-8 py-10">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <input
              ...
              className="w-full form-style bg-richblack-700 rounded-md p-2"
          ...
          <div className="flex flex-col space-y-2">
            ...
            <textarea
              ...
              className="form-style resize-x-none min-h-[130px] w-full bg-richblack-700 rounded-md p-2"
